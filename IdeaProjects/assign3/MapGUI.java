...
public class MapGUI extends JApplet {
    /** The mapseye that will be displayed */
    private MapViewer map;

    /** Time between updates is half a second */
    private static final int TIMER_INTERVAL = 500;

    /** Used for animation of the mapseye colors */
    private Timer timer;
    ...
    class NorthListener implements ActionListener {
        /**
         *  Norths the colors when the button is pushed.
         *
         *  @param e  Holds information about the button-push event
         */
        public void actionPerformed(ActionEvent e) {
    ...
    class EastListener implements ActionListener {
        /**
         *  Easts the colors when the button is pushed.
         *
         *  @param e  Holds information about the button-push event
         */
        public void actionPerformed(ActionEvent e) {
    ...
    class WestListener implements ActionListener {
        /**
         *  Wests the colors when the button is pushed.
         *
         *  @param e  Holds information about the button-push event
         */
        public void actionPerformed(ActionEvent e) {
